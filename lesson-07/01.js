...
let imageIndex = 0; // текущее изображение

const btn1 = document.querySelector("#prev-button"); //прописываем айдишник кнопки

const btn2 = document.querySelector("#next-button");

const imgElement = document.querySelector("#web-tech-image"); // для картинок


imgElement.src = WEB_TECH_IMAGES[imageIndex]; // определяем начальную картинку

btn1.addEventListener(
  "click",
  ()=> {
    imageIndex = (imageIndex - 1 + WEB_TECH_IMAGES.length) % WEB_TECH_IMAGES.length;
    imgElement.src = WEB_TECH_IMAGES[imageIndex];
  }
);
